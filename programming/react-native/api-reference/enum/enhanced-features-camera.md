...
title: EnumEnhancedFeatures - Dynamsoft Capture Vision React Native
description: Enumeration EnumEnhancedFeatures of Dynamsoft Capture Vision React Native Edition defines the enhanced features of the Camera Enhancer that can be activated.
keywords: enhanced features, React Native, camera enhancer, zoom, torch
